...
namespace API1.Controllers
{
    ...
    public class SuministrasController : ControllerBase
    {
        ...
        public async Task<ActionResult<Suministra>> PostSuministra(Suministra suministra)
        {
            ...
            {
                if (SuministraExists(suministra.Id_proveedor))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetSuministra", new { id = suministra.Id_proveedor }, suministra);
        }
        ...
        {
            return _context.Suministra.Any(e => e.Id_proveedor == id);
        }
    }
}
