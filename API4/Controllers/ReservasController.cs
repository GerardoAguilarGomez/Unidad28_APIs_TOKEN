...
namespace API4.Controllers
{
    ...
    public class ReservasController : ControllerBase
    {
        ...
        public async Task<ActionResult<Reserva>> PostReserva(Reserva reserva)
        {
            ...
            {
                if (ReservaExists(reserva.Investigador))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetReserva", new { id = reserva.Investigador }, reserva);
        }
        ...
        {
            return _context.Reservas.Any(e => e.Investigador == id);
        }
    }
}
